...
class Transmissao(TimedBehaviour):
    ...
    def __init__(self, agent, time, message,n):
    ...
    def on_time(self):
        ...
        self.FairnessNOMA.append(Transmission['FairnessAHNOMA'])
        self.FairnessNOMA_PAIRS.append(Transmission['FairnessNOMA_PAIRS'])
        ...
        self.sla['Fairness NOMA Sum rate'] = self.FairnessNOMA
        ...
        self.sla['Fairbess NOMA Pairs'] = self.FairnessNOMA_PAIRS
        self.sla['Fixed NOMA Outage'] = self.OUTAGE
        
        KCT = pd.DataFrame(self.sla)
        KCT.to_csv(f'FArq{self.n}.csv',)
        self.agent.send(self.message)        
...
class Transmission_Agent(Agent):
    def __init__(self, aid,n):
        ...
        self.trans = Transmissao(self, 5, message,self.n)
...
if __name__ == "__main__":
    ...
    for i in range(agents_per_process):
        ...
        agente_init_2 = Transmission_Agent(AID(name=TA_agent_name),n)
